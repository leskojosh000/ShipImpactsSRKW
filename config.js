var config = {
    ...
    byline: false,
    footer: '<a href="https://blagee.github.io/southernresidents/"> Next Chapter <a/>',
    chapters: [
        {
            ...
            onChapterEnter: [
              {
                                  layer: 'core-and-critical-habitats',
                                  opacity: .5,},
                              {
                                  layer: 'core-n-critical-outlines',
                                  opacity: .75,
                          },
            ],
            onChapterExit: [
        ...
        },
        {
            ...
            image: 'https://www.eopugetsound.org/sites/default/files/topical_article/images/killer-whale-and-boat_1.jpg',
            ...
            onChapterEnter: [
              {
                              ...
                              {layer: 'whale-whatching-ports',
                              opacity: 1,},

                              {layer: 'whalewatchinwhales',
                              opacity: .75,},

                              {layer: 'whalewatchingboats',
                              opacity: .5,
                            },
            ],
            onChapterExit: [
            ...
            onChapterEnter: [
              {
                          ...
                          {layer: 'cruiseshipports',
                          opacity: 1,},

                          {layer: 'cruiseshiproutes',
                          opacity: .75,
                        },
            ],
            onChapterExit: [
